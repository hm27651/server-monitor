...
preflight_check() {
    ...
    run_log_info "飞书字段: ${FEISHU_FIELD_TIME}, ${FEISHU_FIELD_IP}, ${FEISHU_FIELD_CPU_INFO}, ${FEISHU_FIELD_CPU_USAGE}, ${FEISHU_FIELD_MEMORY}, ${FEISHU_FIELD_MEM_USAGE}, ${FEISHU_FIELD_DISK_LIST}, ${FEISHU_FIELD_DISK_USAGE}, ${FEISHU_FIELD_DISK_SMART}, ${FEISHU_FIELD_GPU_LIST}, ${FEISHU_FIELD_GPU_USAGE}"
    run_log_info "✓ 前置检查通过"
    return 0
}
...
main() {
    ...
    export FEISHU_FIELD_TIME FEISHU_FIELD_IP FEISHU_FIELD_CPU_INFO FEISHU_FIELD_CPU_USAGE
